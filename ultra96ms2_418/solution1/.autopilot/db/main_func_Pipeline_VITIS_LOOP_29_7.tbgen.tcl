set moduleName main_func_Pipeline_VITIS_LOOP_29_7
set isTopModule 0
...
set C_modelName {main_func_Pipeline_VITIS_LOOP_29_7}
set C_modelType { void 0 }
set C_modelArgList {
	{ wt int 16 regular {axi_master 0}  }
	{ sext_ln29 int 63 regular  }
	{ bias_buf1x1 int 16 regular {array 48 { 0 3 } 0 1 } {global 1}  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "wt", "interface" : "axi_master", "bitwidth" : 16, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "weights_3x3","offset": { "type": "dynamic","port_name": "weights_3x3","bundle": "control"},"direction": "READONLY"},{"cName": "bias_3x3","offset": { "type": "dynamic","port_name": "bias_3x3","bundle": "control"},"direction": "READONLY"},{"cName": "weights_1x1","offset": { "type": "dynamic","port_name": "weights_1x1","bundle": "control"},"direction": "READONLY"},{"cName": "bias_1x1","offset": { "type": "dynamic","port_name": "bias_1x1","bundle": "control"},"direction": "READONLY"}]}]} , 
 	{ "Name" : "sext_ln29", "interface" : "wire", "bitwidth" : 63, "direction" : "READONLY"} , 
 	{ "Name" : "bias_buf1x1", "interface" : "memory", "bitwidth" : 16, "direction" : "WRITEONLY", "extern" : 0} ]}
...
set portList { 
	...
	{ sext_ln29 sc_in sc_lv 63 signal 1 } 
	{ bias_buf1x1_address0 sc_out sc_lv 6 signal 2 } 
	{ bias_buf1x1_ce0 sc_out sc_logic 1 signal 2 } 
	{ bias_buf1x1_we0 sc_out sc_logic 1 signal 2 } 
	{ bias_buf1x1_d0 sc_out sc_lv 16 signal 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln29", "direction": "in", "datatype": "sc_lv", "bitwidth":63, "type": "signal", "bundle":{"name": "sext_ln29", "role": "default" }} , 
 	...
 	{ "name": "bias_buf1x1_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "bias_buf1x1", "role": "we0" }} , 
 	{ "name": "bias_buf1x1_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "bias_buf1x1", "role": "d0" }}  ]}
...
set Spec2ImplPortList { 
	...
	sext_ln29 { ap_none {  { sext_ln29 in_data 0 63 } } }
	bias_buf1x1 { ap_memory {  { bias_buf1x1_address0 mem_address 1 6 }  { bias_buf1x1_ce0 mem_ce 1 1 }  { bias_buf1x1_we0 mem_we 1 1 }  { bias_buf1x1_d0 mem_din 1 16 } } }
}
