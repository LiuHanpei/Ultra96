...
entity main_func_main_func_Pipeline_VITIS_LOOP_22_4 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of main_func_main_func_Pipeline_VITIS_LOOP_22_4 is 
...
attribute shreg_extract : string;
    ...
    signal icmp_ln22_fu_77_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_condition_exit_pp0_iter0_stage0 : STD_LOGIC;
    signal ap_loop_exit_ready : STD_LOGIC;
    signal ap_ready_int : STD_LOGIC;
    signal wt_blk_n_R : STD_LOGIC;
    signal ap_block_pp0_stage0 : BOOLEAN;
    signal f_reg_125 : STD_LOGIC_VECTOR (1 downto 0);
    signal ap_block_pp0_stage0_11001 : BOOLEAN;
    signal f_1_fu_50 : STD_LOGIC_VECTOR (1 downto 0) := "00";
    signal add_ln22_fu_83_p2 : STD_LOGIC_VECTOR (1 downto 0);
    signal ap_loop_init : STD_LOGIC;
    signal ap_sig_allocacmp_f : STD_LOGIC_VECTOR (1 downto 0);
...
begin
    ...
    f_1_fu_50_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if (((icmp_ln22_fu_77_p2 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1))) then 
                    f_1_fu_50 <= add_ln22_fu_83_p2;
                elsif ((ap_loop_init = ap_const_logic_1)) then 
                    f_1_fu_50 <= ap_const_lv2_0;
                end if;
            end if; 
        end if;
    end process;
    ...
    add_ln22_fu_83_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_f) + unsigned(ap_const_lv2_1));
    ...
    ap_condition_exit_pp0_iter0_stage0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0_subdone, icmp_ln22_fu_77_p2)
    begin
        if (((icmp_ln22_fu_77_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    ap_sig_allocacmp_f_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0, f_1_fu_50, ap_loop_init)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_loop_init = ap_const_logic_1))) then 
            ap_sig_allocacmp_f <= ap_const_lv2_0;
        else 
            ap_sig_allocacmp_f <= f_1_fu_50;
        end if; 
    end process;

    bias_buf3x3_0 <= m_axi_wt_RDATA;

    bias_buf3x3_0_ap_vld_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, f_reg_125, ap_block_pp0_stage0_11001)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (f_reg_125 = ap_const_lv2_0))) then 
            bias_buf3x3_0_ap_vld <= ap_const_logic_1;
        else 
            bias_buf3x3_0_ap_vld <= ap_const_logic_0;
        end if; 
    end process;

    bias_buf3x3_1 <= m_axi_wt_RDATA;

    bias_buf3x3_1_ap_vld_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, f_reg_125, ap_block_pp0_stage0_11001)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (f_reg_125 = ap_const_lv2_1))) then 
            bias_buf3x3_1_ap_vld <= ap_const_logic_1;
        else 
            bias_buf3x3_1_ap_vld <= ap_const_logic_0;
        end if; 
    end process;

    bias_buf3x3_2 <= m_axi_wt_RDATA;

    bias_buf3x3_2_ap_vld_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, f_reg_125, ap_block_pp0_stage0_11001)
    begin
        if ((not((f_reg_125 = ap_const_lv2_1)) and not((f_reg_125 = ap_const_lv2_0)) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
            bias_buf3x3_2_ap_vld <= ap_const_logic_1;
        else 
            bias_buf3x3_2_ap_vld <= ap_const_logic_0;
        end if; 
    end process;

    icmp_ln22_fu_77_p2 <= "1" when (ap_sig_allocacmp_f = ap_const_lv2_3) else "0";
