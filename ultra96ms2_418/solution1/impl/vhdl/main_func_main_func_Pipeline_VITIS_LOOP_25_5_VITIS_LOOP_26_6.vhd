...
entity main_func_main_func_Pipeline_VITIS_LOOP_25_5_VITIS_LOOP_26_6 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of main_func_main_func_Pipeline_VITIS_LOOP_25_5_VITIS_LOOP_26_6 is 
...
attribute shreg_extract : string;
    ...
    signal icmp_ln25_fu_146_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal wt_addr_read_reg_256 : STD_LOGIC_VECTOR (15 downto 0);
    signal zext_ln25_fu_203_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal c_fu_62 : STD_LOGIC_VECTOR (1 downto 0) := "00";
    signal add_ln26_fu_210_p2 : STD_LOGIC_VECTOR (1 downto 0);
    signal ap_loop_init : STD_LOGIC;
    signal f_fu_66 : STD_LOGIC_VECTOR (5 downto 0) := "000000";
    signal select_ln25_1_fu_195_p3 : STD_LOGIC_VECTOR (5 downto 0);
    signal indvar_flatten17_fu_70 : STD_LOGIC_VECTOR (7 downto 0) := "00000000";
    signal add_ln25_1_fu_152_p2 : STD_LOGIC_VECTOR (7 downto 0);
    signal ap_sig_allocacmp_indvar_flatten17_load : STD_LOGIC_VECTOR (7 downto 0);
    signal select_ln25_fu_187_p3 : STD_LOGIC_VECTOR (1 downto 0);
    signal icmp_ln26_fu_181_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal add_ln25_fu_175_p2 : STD_LOGIC_VECTOR (5 downto 0);
...
begin
    ...
    f_fu_66_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_boolean_0 = ap_block_pp0_stage0_11001)) then
                if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_loop_init = ap_const_logic_1))) then 
                    f_fu_66 <= ap_const_lv6_0;
                elsif ((ap_enable_reg_pp0_iter2 = ap_const_logic_1)) then 
    ...
    indvar_flatten17_fu_70_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if (((icmp_ln25_fu_146_p2 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1))) then 
                    indvar_flatten17_fu_70 <= add_ln25_1_fu_152_p2;
                elsif ((ap_loop_init = ap_const_logic_1)) then 
                    indvar_flatten17_fu_70 <= ap_const_lv8_0;
                end if;
            end if; 
        end if;
    end process;
    ...
    add_ln25_1_fu_152_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_indvar_flatten17_load) + unsigned(ap_const_lv8_1));
    add_ln25_fu_175_p2 <= std_logic_vector(unsigned(f_fu_66) + unsigned(ap_const_lv6_1));
    add_ln26_fu_210_p2 <= std_logic_vector(unsigned(select_ln25_fu_187_p3) + unsigned(ap_const_lv2_1));
    ...
    ap_condition_exit_pp0_iter0_stage0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0_subdone, icmp_ln25_fu_146_p2)
    begin
        if (((icmp_ln25_fu_146_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    ap_sig_allocacmp_indvar_flatten17_load_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0, ap_loop_init, indvar_flatten17_fu_70)
    begin
    ...
    icmp_ln25_fu_146_p2 <= "1" when (ap_sig_allocacmp_indvar_flatten17_load = ap_const_lv8_90) else "0";
    icmp_ln26_fu_181_p2 <= "1" when (c_fu_62 = ap_const_lv2_3) else "0";
    ...
    select_ln25_1_fu_195_p3 <= 
        add_ln25_fu_175_p2 when (icmp_ln26_fu_181_p2(0) = '1') else 
        f_fu_66;
    select_ln25_fu_187_p3 <= 
        ap_const_lv2_0 when (icmp_ln26_fu_181_p2(0) = '1') else 
        c_fu_62;
    weight_buf1x1_0_address0 <= zext_ln25_fu_203_p1(6 - 1 downto 0);

    weight_buf1x1_0_ce0_assign_proc : process(ap_enable_reg_pp0_iter2, ap_block_pp0_stage0_11001)
    begin
    ...
    weight_buf1x1_0_d0 <= wt_addr_read_reg_256;

    weight_buf1x1_0_we0_assign_proc : process(ap_enable_reg_pp0_iter2, ap_block_pp0_stage0_11001, select_ln25_fu_187_p3)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (select_ln25_fu_187_p3 = ap_const_lv2_0))) then 
            weight_buf1x1_0_we0 <= ap_const_logic_1;
        else 
            weight_buf1x1_0_we0 <= ap_const_logic_0;
        end if; 
    end process;

    weight_buf1x1_1_address0 <= zext_ln25_fu_203_p1(6 - 1 downto 0);

    weight_buf1x1_1_ce0_assign_proc : process(ap_enable_reg_pp0_iter2, ap_block_pp0_stage0_11001)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1))) then 
    ...
    weight_buf1x1_1_d0 <= wt_addr_read_reg_256;

    weight_buf1x1_1_we0_assign_proc : process(ap_enable_reg_pp0_iter2, ap_block_pp0_stage0_11001, select_ln25_fu_187_p3)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (select_ln25_fu_187_p3 = ap_const_lv2_1))) then 
            weight_buf1x1_1_we0 <= ap_const_logic_1;
        else 
            weight_buf1x1_1_we0 <= ap_const_logic_0;
        end if; 
    end process;

    weight_buf1x1_2_address0 <= zext_ln25_fu_203_p1(6 - 1 downto 0);
    ...
    weight_buf1x1_2_d0 <= wt_addr_read_reg_256;

    weight_buf1x1_2_we0_assign_proc : process(ap_enable_reg_pp0_iter2, ap_block_pp0_stage0_11001, select_ln25_fu_187_p3)
    begin
        if ((not((select_ln25_fu_187_p3 = ap_const_lv2_0)) and not((select_ln25_fu_187_p3 = ap_const_lv2_1)) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1))) then 
            weight_buf1x1_2_we0 <= ap_const_logic_1;
        else 
    ...
    zext_ln25_fu_203_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(select_ln25_1_fu_195_p3),64));
end behav;
