...
$(ObjDir)/conv1x1.cpp_pre.cpp.tb.o : conv1x1.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling conv1x1.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c  $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/dw_conv3x3.cpp_pre.cpp.tb.o : dw_conv3x3.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling dw_conv3x3.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c  $(IFLAG) $(DFLAG) $< -o $@; \
