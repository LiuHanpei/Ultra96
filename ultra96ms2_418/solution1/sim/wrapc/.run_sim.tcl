...
# 
# ==============================================================
set ::env(PATH) "$::env(PATH);E:/Vivado/Vitis_HLS/2023.2/win64/tools/fpo_v7_1"
set ::env(PATH) "$::env(PATH);E:/Vivado/Vitis_HLS/2023.2/win64/tools/fft_v9_1"
set ::env(PATH) "$::env(PATH);E:/Vivado/Vitis_HLS/2023.2/win64/tools/fir_v7_0"
set ::env(PATH) "$::env(PATH);E:/Vivado/Vitis_HLS/2023.2/win64/tools/dds_v6_0"
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "main_func.autotvin.dat"
	set constFileTvOut       "main_func.autotvout.dat"
	set constFileHdlTvIn     "main_func.autohdltvin.dat"
	set constFileHdlTvOut    "main_func.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
