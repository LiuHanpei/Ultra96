...
//------------------------Parameter----------------------
`define TV_IN_wt "../tv/cdatafile/c.main_func.autotvin_wt.dat"
`define TV_OUT_wt "../tv/rtldatafile/rtl.main_func.autotvout_wt.dat"
 parameter wt_ADDR_BITWIDTH = 32'd 64;
 parameter wt_AWUSER_BITWIDTH = 32'd 1;
 parameter wt_DATA_BITWIDTH = 32'd 32;
 parameter wt_WUSER_BITWIDTH = 32'd 1;
 parameter wt_ID_BITWIDTH = 32'd 1;
 parameter wt_RUSER_BITWIDTH = 32'd 1;
 parameter wt_BUSER_BITWIDTH = 32'd 1;
 parameter   FIFO_DEPTH            =   1 + 1;
 parameter   mem_page_num            =   32'd 3;
 parameter   FIFO_DEPTH_ADDR_WIDTH   =    32'd 32;
parameter wt_C_DATA_BITWIDTH = 32'd 16;
parameter wt_transaction_depth = 32'd 222;
parameter wt_mem_depth = 32'd 111;
parameter ReadReqLatency = 32'd 1;
parameter WriteReqLatency = 32'd 1;
// Input and Output
input clk;
input reset;
input  TRAN_wt_AWVALID;
output  TRAN_wt_AWREADY;
input [wt_ADDR_BITWIDTH - 1 : 0] TRAN_wt_AWADDR;
input [wt_ID_BITWIDTH - 1 : 0] TRAN_wt_AWID;
input [8 - 1 : 0] TRAN_wt_AWLEN;
input [3 - 1 : 0] TRAN_wt_AWSIZE;
input [2 - 1 : 0] TRAN_wt_AWBURST;
input [2 - 1 : 0] TRAN_wt_AWLOCK;
input [4 - 1 : 0] TRAN_wt_AWCACHE;
input [3 - 1 : 0] TRAN_wt_AWPROT;
input [4 - 1 : 0] TRAN_wt_AWQOS;
input [4 - 1 : 0] TRAN_wt_AWREGION;
input [wt_AWUSER_BITWIDTH - 1 : 0] TRAN_wt_AWUSER;
input  TRAN_wt_WVALID;
output  TRAN_wt_WREADY;
input [wt_DATA_BITWIDTH - 1 : 0] TRAN_wt_WDATA;
input [wt_DATA_BITWIDTH/8 - 1 : 0] TRAN_wt_WSTRB;
input  TRAN_wt_WLAST;
input  TRAN_wt_WID;
input [wt_WUSER_BITWIDTH - 1 : 0] TRAN_wt_WUSER;
input  TRAN_wt_ARVALID;
output  TRAN_wt_ARREADY;
input [wt_ADDR_BITWIDTH - 1 : 0] TRAN_wt_ARADDR;
input [wt_ID_BITWIDTH - 1 : 0] TRAN_wt_ARID;
input [8 - 1 : 0] TRAN_wt_ARLEN;
input [3 - 1 : 0] TRAN_wt_ARSIZE;
input [2 - 1 : 0] TRAN_wt_ARBURST;
input [2 - 1 : 0] TRAN_wt_ARLOCK;
input [4 - 1 : 0] TRAN_wt_ARCACHE;
input [3 - 1 : 0] TRAN_wt_ARPROT;
input [4 - 1 : 0] TRAN_wt_ARQOS;
input [4 - 1 : 0] TRAN_wt_ARREGION;
input  TRAN_wt_ARUSER;
output  TRAN_wt_RVALID;
input  TRAN_wt_RREADY;
output [wt_DATA_BITWIDTH - 1 : 0] TRAN_wt_RDATA;
output  TRAN_wt_RLAST;
output [wt_ID_BITWIDTH - 1 : 0] TRAN_wt_RID;
output [wt_RUSER_BITWIDTH - 1 : 0] TRAN_wt_RUSER;
output [2 - 1 : 0] TRAN_wt_RRESP;
output  TRAN_wt_BVALID;
input  TRAN_wt_BREADY;
output [2 - 1 : 0] TRAN_wt_BRESP;
output [wt_ID_BITWIDTH - 1 : 0] TRAN_wt_BID;
output [wt_BUSER_BITWIDTH - 1 : 0] TRAN_wt_BUSER;
input ready;
input done;

// Inner signals
// AW request fifo
reg    [wt_ADDR_BITWIDTH - 1 : 0]         FIFO_AW_req_ADDR           [0 : FIFO_DEPTH - 1]; 
reg    [wt_ADDR_BITWIDTH - 1 : 0]         FIFO_AW_req_ADDR_tmp; 
...
// AR request fifo
reg    [wt_ADDR_BITWIDTH - 1 : 0]         FIFO_AR_req_ADDR           [0 : FIFO_DEPTH - 1]; 
reg    [wt_ADDR_BITWIDTH - 1 : 0]         FIFO_AR_req_ADDR_tmp; 
...
// WDATA fifo
reg    [wt_DATA_BITWIDTH - 1 : 0]         FIFO_WDATA           [0 : FIFO_DEPTH - 1]; 
reg    [wt_DATA_BITWIDTH/8 - 1 : 0]       FIFO_WSTRB           [0 : FIFO_DEPTH - 1]; 
...
reg    BRESP_tmp = 0;
reg    [wt_ID_BITWIDTH - 1 : 0] BID_tmp = 0;
reg    send_one_BRESP = 0;
reg    [31 : 0] BRESP_counter = 0;

reg [wt_DATA_BITWIDTH - 1:0] RDATA_tmp = 0;
reg [2 - 1:0] RRESP_tmp = 0;
reg RLAST_tmp = 0;
reg RVALID_tmp = 0;
reg [wt_ID_BITWIDTH - 1 : 0] RID_tmp = 0;
reg [wt_DATA_BITWIDTH - 1 : 0] wt_mem_0 [0: wt_mem_depth - 1] = '{default : 'h0}; 
reg [wt_DATA_BITWIDTH - 1 : 0] wt_mem_1 [0: wt_mem_depth - 1] = '{default : 'h0}; 
reg [wt_DATA_BITWIDTH - 1 : 0] wt_mem_2 [0: wt_mem_depth - 1] = '{default : 'h0}; 
reg [31 : 0] clk_counter ;
reg [31 : 0] current_AW_req_transaction = 0 ;
reg [31 : 0] current_AR_req_transaction = -1 ;
reg write_processing = 0;
reg [wt_ADDR_BITWIDTH - 1 : 0] wr_processing_addr = 0;
reg [wt_ADDR_BITWIDTH - 1 : 0] rd_processing_addr = 0;
reg [31 : 0] wr_processing_trans_num = 0;
reg [wt_DATA_BITWIDTH - 1 : 0] wr_processing_data = 0;
assign TRAN_wt_AWREADY    =    !FIFO_AW_req_full; 
assign TRAN_wt_ARREADY    =    !FIFO_AR_req_full; 
assign TRAN_wt_WREADY    =     !(FIFO_WDATA_req_full || FIFO_WDATA_size_full); 
assign TRAN_wt_BVALID = (BRESP_counter == 0) ? 0 : 1;
assign TRAN_wt_BRESP = BRESP_tmp;
assign TRAN_wt_BID = BID_tmp;
assign TRAN_wt_RDATA = RDATA_tmp;
assign TRAN_wt_RRESP = RRESP_tmp;
assign TRAN_wt_RLAST = RLAST_tmp;
assign TRAN_wt_RID = RID_tmp;
assign TRAN_wt_RVALID = RVALID_tmp;

initial begin : initialize_offset
  integer DATA_byte_num; 
  integer c_bitwidth;
  DATA_byte_num = 0; 
  c_bitwidth = wt_C_DATA_BITWIDTH;
end
...
always @ (posedge clk or reset) begin 
    if(reset === 0) begin 
        ...
        if(TRAN_wt_AWREADY & TRAN_wt_AWVALID ) begin    // RTL is sending a AW_request to the bus         
            FIFO_AW_req_SIZE [FIFO_AW_req_ptr_w]    =   TRAN_wt_AWSIZE; 
            FIFO_AW_req_ADDR [FIFO_AW_req_ptr_w]    =   TRAN_wt_AWADDR; 
            FIFO_AW_req_LEN  [FIFO_AW_req_ptr_w]    =   TRAN_wt_AWLEN; 
            FIFO_AW_req_BURST[FIFO_AW_req_ptr_w]    =   TRAN_wt_AWBURST; 
            FIFO_AW_req_ID[FIFO_AW_req_ptr_w]    =   TRAN_wt_AWID; 
...
always @ (posedge clk or reset) begin 
    if(reset === 0) begin 
        ...
        if(TRAN_wt_ARREADY & TRAN_wt_ARVALID ) begin    // RTL is sending a AR_request to the bus         
            FIFO_AR_req_SIZE [FIFO_AR_req_ptr_w]    =   TRAN_wt_ARSIZE; 
            FIFO_AR_req_ADDR [FIFO_AR_req_ptr_w]    =   TRAN_wt_ARADDR; 
            FIFO_AR_req_LEN  [FIFO_AR_req_ptr_w]    =   TRAN_wt_ARLEN; 
            FIFO_AR_req_BURST[FIFO_AR_req_ptr_w]    =   TRAN_wt_ARBURST; 
            FIFO_AR_req_ID[FIFO_AR_req_ptr_w]    =   TRAN_wt_ARID; 
...
always @ (posedge clk or reset) begin 
    if(reset === 0) begin 
        ...
        if(TRAN_wt_WREADY & TRAN_wt_WVALID) begin    // RTL is sending a WDATA data 
            FIFO_WDATA [FIFO_WDATA_req_ptr_w]    <=   TRAN_wt_WDATA; 
            FIFO_WSTRB [FIFO_WDATA_req_ptr_w]    <=   TRAN_wt_WSTRB; 
            if(FIFO_WDATA_req_ptr_w != FIFO_DEPTH - 1) 
                FIFO_WDATA_req_ptr_w <= FIFO_WDATA_req_ptr_w + 1; 
            else 
                FIFO_WDATA_req_ptr_w <= 0; 
            if (TRAN_wt_WLAST == 1 ) begin
...
always @(posedge clk or reset) begin 
    if(reset === 0) begin 
      ...
      if(TRAN_wt_AWVALID && TRAN_wt_AWREADY && ((FIFO_AW_req_ptr_w - FIFO_AW_req_ptr_r) % FIFO_DEPTH == FIFO_DEPTH - 1)) 
          FIFO_AW_req_flag <= 1; 
      # 0.4;
...
always @(posedge clk or reset) begin 
    if(reset === 0) begin 
      ...
      if(TRAN_wt_ARVALID && TRAN_wt_ARREADY && ((FIFO_AR_req_ptr_w - FIFO_AR_req_ptr_r) % FIFO_DEPTH == FIFO_DEPTH - 1)) 
          FIFO_AR_req_flag <= 1; 
      # 0.4;
...
always @(posedge clk or reset) begin 
    if(reset === 0) begin 
      ...
      if(TRAN_wt_WVALID && TRAN_wt_WREADY && ((FIFO_WDATA_req_ptr_w - FIFO_WDATA_req_ptr_r) % FIFO_DEPTH == FIFO_DEPTH - 1)) 
...
always @(posedge clk or reset) begin 
    if(reset === 0) begin 
      ...
      if(TRAN_wt_WVALID && TRAN_wt_WREADY && TRAN_wt_WLAST && ((FIFO_WDATA_size_ptr_w - FIFO_WDATA_size_ptr_r) % FIFO_DEPTH == FIFO_DEPTH - 1)) 
...
always @(posedge clk or reset) begin 
    if(reset === 0) begin 
        ...
        if ( send_one_BRESP == 'b1 && !(BRESP_counter != 32'h0 && TRAN_wt_BREADY) ) begin
            BRESP_counter <= BRESP_counter + 1;
        end else if (send_one_BRESP != 'b1 && (BRESP_counter != 32'h0 && TRAN_wt_BREADY)) begin
            BRESP_counter <= BRESP_counter - 1;
        end
    end
end
...
initial begin : AW_request_proc
    ...
    reg [wt_DATA_BITWIDTH - 1 : 0] FIFO_WDATA_tmp;
    reg [wt_DATA_BITWIDTH - 1 : 0] WDATA_tmp;
    reg [wt_DATA_BITWIDTH/8 - 1 : 0] FIFO_WSTRB_tmp;
    @(posedge clk);
    ...
    while (1) begin
        if (FIFO_AW_req_empty === 1 || BRESP_counter == 32) begin
            ...
            if (FIFO_AW_req_ADDR_tmp/data_byte_size > wt_mem_depth) begin
                $display ("F:/vivado_projects/EE4951_TaWork/ultra96ms2_418/solution1/sim/verilog/AESL_axi_master_wt.v: Write request address %d exceed AXI master wt array depth: %d",FIFO_AW_req_ADDR_tmp/data_byte_size, wt_mem_depth); 
                $finish;
            end
            ...
            if (FIFO_AW_req_BURST_tmp === 1) begin
                ...
                while (counter != output_length + 1) begin
                    if (FIFO_WDATA_req_empty != 1) begin 
                            ...
                            if (FIFO_WSTRB_tmp[i] == 1) begin 
                                ...
                                for (j=(i*8); j< (i+1)*8 ; j= j+1) begin
                                    case(FIFO_AW_req_transaction_tmp % mem_page_num)
                                        0 : WDATA_tmp[j] = wt_mem_0[FIFO_AW_req_ADDR_tmp / data_byte_size + counter][j];
                                        1 : WDATA_tmp[j] = wt_mem_1[FIFO_AW_req_ADDR_tmp / data_byte_size + counter][j];
                                        2 : WDATA_tmp[j] = wt_mem_2[FIFO_AW_req_ADDR_tmp / data_byte_size + counter][j];
                        ...
                        case(FIFO_AW_req_transaction_tmp % mem_page_num)
                            0 : wt_mem_0[FIFO_AW_req_ADDR_tmp / data_byte_size + counter] <= WDATA_tmp;
                            1 : wt_mem_1[FIFO_AW_req_ADDR_tmp / data_byte_size + counter] <= WDATA_tmp;
                            2 : wt_mem_2[FIFO_AW_req_ADDR_tmp / data_byte_size + counter] <= WDATA_tmp;
                            default: $display("The page_num of AXI write is not valid!");
                        endcase
                    ...
                    if (FIFO_WDATA_req_empty != 1) begin 
                        ...
                        for (i = 0 ; i < data_byte_size; i = i + 1) begin
                            if (FIFO_WSTRB_tmp[i] == 1) begin 
                                ...
                                for (j=(i*8); j< (i+1)*8 ; j= j+1) begin
                                    case(FIFO_AW_req_transaction_tmp % mem_page_num)
                                        0 : WDATA_tmp[j] = wt_mem_0[FIFO_AW_req_ADDR_tmp / data_byte_size][j];
                                        1 : WDATA_tmp[j] = wt_mem_1[FIFO_AW_req_ADDR_tmp / data_byte_size][j];
                                        2 : WDATA_tmp[j] = wt_mem_2[FIFO_AW_req_ADDR_tmp / data_byte_size][j];
                                        default: $display("The page_num of AXI write is not valid!");
                                    endcase
                                end
                            end
                        ...
                        wr_processing_data = WDATA_tmp;
                        case(FIFO_AW_req_transaction_tmp % mem_page_num)
                            0 : wt_mem_0[FIFO_AW_req_ADDR_tmp / data_byte_size] <= WDATA_tmp;
                            1 : wt_mem_1[FIFO_AW_req_ADDR_tmp / data_byte_size] <= WDATA_tmp;
                            2 : wt_mem_2[FIFO_AW_req_ADDR_tmp / data_byte_size] <= WDATA_tmp;
                            default: $display("The page_num of AXI write is not valid!");
                        endcase
...
initial begin : AR_request_proc
    ...
    while (1) begin
        ...
        if (FIFO_AR_req_empty) begin
            ...
            if (FIFO_AR_req_ADDR_tmp/data_byte_size > wt_mem_depth) begin
                $display ("F:/vivado_projects/EE4951_TaWork/ultra96ms2_418/solution1/sim/verilog/AESL_axi_master_wt.v: Read request address %d exceed AXI master wt array depth: %d",FIFO_AR_req_ADDR_tmp/data_byte_size, wt_mem_depth); 
                $finish;
            end
            ...
            if (FIFO_AR_req_BURST_tmp === 1) begin
                ...
                while (counter != input_length + 1) begin
                    ...
                    if ((write_processing == 1) && (wr_processing_addr == rd_processing_addr) && (wr_processing_trans_num == FIFO_AR_req_transaction_tmp))
                        ...
                        case(FIFO_AR_req_transaction_tmp % mem_page_num)
                            0 : RDATA_tmp <= wt_mem_0[FIFO_AR_req_ADDR_tmp / data_byte_size +   counter] ;
                            1 : RDATA_tmp <= wt_mem_1[FIFO_AR_req_ADDR_tmp / data_byte_size +   counter] ;
                            2 : RDATA_tmp <= wt_mem_2[FIFO_AR_req_ADDR_tmp / data_byte_size +   counter] ;
                    ...
                    @(posedge clk);
                    if (RVALID_tmp && TRAN_wt_RREADY) begin
                        counter = counter + 1;
                    end 
                end
                RVALID_tmp <= 0;
                ...
                while (counter != input_length + 1) begin
                    ...
                    if ((write_processing == 1) && (wr_processing_addr == rd_processing_addr) && (wr_processing_trans_num == FIFO_AR_req_transaction_tmp))
                        ...
                        case(FIFO_AR_req_transaction_tmp % mem_page_num)
                            0 : RDATA_tmp <= wt_mem_0[FIFO_AR_req_ADDR_tmp / data_byte_size ] ;
                            1 : RDATA_tmp <= wt_mem_1[FIFO_AR_req_ADDR_tmp / data_byte_size ] ;
                            2 : RDATA_tmp <= wt_mem_2[FIFO_AR_req_ADDR_tmp / data_byte_size ] ;
                            default: $display("The page_num of AXI read is not valid!");
                        endcase
                    RVALID_tmp <= 1;
                    RRESP_tmp <= 0;
...
initial begin : read_file_process 
  ...
  reg [wt_DATA_BITWIDTH - 1 : 0] mem_tmp; 
  integer i; 
  transaction_num = 0;
  fp = $fopen(`TV_IN_wt,"rb"); 
  if(fp == 0) begin                               // Failed to open file 
      $display("Failed to open file \"%s\"!", `TV_IN_wt); 
      $finish; 
  end 
  ...
  while (trans_depth != 64'h5a5aa5a50f0ff0f0)  begin
      ...
      mem_tmp[wt_DATA_BITWIDTH - 1: 0] = 0;
      for(i = 0; i < wt_transaction_depth; i = i + 1) begin 
          ...
          if (i%2 == 1) begin
              case(mem_page)
                  0 : wt_mem_0[i/2] = mem_tmp;
                  1 : wt_mem_1[i/2] = mem_tmp;
                  2 : wt_mem_2[i/2] = mem_tmp;
