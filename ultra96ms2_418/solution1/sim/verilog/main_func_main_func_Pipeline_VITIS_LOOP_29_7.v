...
module main_func_main_func_Pipeline_VITIS_LOOP_29_7 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
output   bias_buf1x1_we0;
output  [15:0] bias_buf1x1_d0;
...
reg   [5:0] f_1_reg_127;
reg   [5:0] f_1_reg_127_pp0_iter1_reg;
reg   [15:0] wt_addr_read_reg_136;
wire   [63:0] zext_ln29_fu_111_p1;
reg   [5:0] f_fu_48;
wire   [5:0] add_ln29_fu_94_p2;
wire    ap_loop_init;
...
assign add_ln29_fu_94_p2 = (ap_sig_allocacmp_f_1 + 6'd1);
...
assign bias_buf1x1_address0 = zext_ln29_fu_111_p1;

assign bias_buf1x1_d0 = wt_addr_read_reg_136;

assign icmp_ln29_fu_88_p2 = ((ap_sig_allocacmp_f_1 == 6'd48) ? 1'b1 : 1'b0);
...
assign zext_ln29_fu_111_p1 = f_1_reg_127_pp0_iter1_reg;

endmodule //main_func_main_func_Pipeline_VITIS_LOOP_29_7
