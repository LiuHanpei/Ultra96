...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.main_func.autotvin_fm.dat"
         "c.main_func.autotvin_wt.dat"
         "c.main_func.autotvin_input_feature_map.dat"
         "c.main_func.autotvin_weights_3x3.dat"
         "c.main_func.autotvin_bias_3x3.dat"
         "c.main_func.autotvin_weights_1x1.dat"
         "c.main_func.autotvin_bias_1x1.dat"
         "c.main_func.autotvin_output_feature_map.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.main_func.autotvout_fm.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
