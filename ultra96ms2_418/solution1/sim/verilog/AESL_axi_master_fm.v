...
//------------------------Parameter----------------------
`define TV_IN_fm "../tv/cdatafile/c.main_func.autotvin_fm.dat"
`define TV_OUT_fm "../tv/rtldatafile/rtl.main_func.autotvout_fm.dat"
 parameter fm_ADDR_BITWIDTH = 32'd 64;
 parameter fm_AWUSER_BITWIDTH = 32'd 1;
 parameter fm_DATA_BITWIDTH = 32'd 32;
 parameter fm_WUSER_BITWIDTH = 32'd 1;
 parameter fm_ID_BITWIDTH = 32'd 1;
 parameter fm_RUSER_BITWIDTH = 32'd 1;
 parameter fm_BUSER_BITWIDTH = 32'd 1;
 parameter   FIFO_DEPTH            =   1 + 1;
 parameter   mem_page_num            =   32'd 3;
 parameter   FIFO_DEPTH_ADDR_WIDTH   =    32'd 32;
parameter fm_C_DATA_BITWIDTH = 32'd 16;
parameter fm_transaction_depth = 32'd 2611200;
parameter fm_mem_depth = 32'd 1305600;
parameter ReadReqLatency = 32'd 1;
parameter WriteReqLatency = 32'd 1;
// Input and Output
input clk;
input reset;
input  TRAN_fm_AWVALID;
output  TRAN_fm_AWREADY;
input [fm_ADDR_BITWIDTH - 1 : 0] TRAN_fm_AWADDR;
input [fm_ID_BITWIDTH - 1 : 0] TRAN_fm_AWID;
input [8 - 1 : 0] TRAN_fm_AWLEN;
input [3 - 1 : 0] TRAN_fm_AWSIZE;
input [2 - 1 : 0] TRAN_fm_AWBURST;
input [2 - 1 : 0] TRAN_fm_AWLOCK;
input [4 - 1 : 0] TRAN_fm_AWCACHE;
input [3 - 1 : 0] TRAN_fm_AWPROT;
input [4 - 1 : 0] TRAN_fm_AWQOS;
input [4 - 1 : 0] TRAN_fm_AWREGION;
input [fm_AWUSER_BITWIDTH - 1 : 0] TRAN_fm_AWUSER;
input  TRAN_fm_WVALID;
output  TRAN_fm_WREADY;
input [fm_DATA_BITWIDTH - 1 : 0] TRAN_fm_WDATA;
input [fm_DATA_BITWIDTH/8 - 1 : 0] TRAN_fm_WSTRB;
input  TRAN_fm_WLAST;
input  TRAN_fm_WID;
input [fm_WUSER_BITWIDTH - 1 : 0] TRAN_fm_WUSER;
input  TRAN_fm_ARVALID;
output  TRAN_fm_ARREADY;
input [fm_ADDR_BITWIDTH - 1 : 0] TRAN_fm_ARADDR;
input [fm_ID_BITWIDTH - 1 : 0] TRAN_fm_ARID;
input [8 - 1 : 0] TRAN_fm_ARLEN;
input [3 - 1 : 0] TRAN_fm_ARSIZE;
input [2 - 1 : 0] TRAN_fm_ARBURST;
input [2 - 1 : 0] TRAN_fm_ARLOCK;
input [4 - 1 : 0] TRAN_fm_ARCACHE;
input [3 - 1 : 0] TRAN_fm_ARPROT;
input [4 - 1 : 0] TRAN_fm_ARQOS;
input [4 - 1 : 0] TRAN_fm_ARREGION;
input  TRAN_fm_ARUSER;
output  TRAN_fm_RVALID;
input  TRAN_fm_RREADY;
output [fm_DATA_BITWIDTH - 1 : 0] TRAN_fm_RDATA;
output  TRAN_fm_RLAST;
output [fm_ID_BITWIDTH - 1 : 0] TRAN_fm_RID;
output [fm_RUSER_BITWIDTH - 1 : 0] TRAN_fm_RUSER;
output [2 - 1 : 0] TRAN_fm_RRESP;
output  TRAN_fm_BVALID;
input  TRAN_fm_BREADY;
output [2 - 1 : 0] TRAN_fm_BRESP;
output [fm_ID_BITWIDTH - 1 : 0] TRAN_fm_BID;
output [fm_BUSER_BITWIDTH - 1 : 0] TRAN_fm_BUSER;
input ready;
input done;

// Inner signals
// AW request fifo
reg    [fm_ADDR_BITWIDTH - 1 : 0]         FIFO_AW_req_ADDR           [0 : FIFO_DEPTH - 1]; 
reg    [fm_ADDR_BITWIDTH - 1 : 0]         FIFO_AW_req_ADDR_tmp; 
...
// AR request fifo
reg    [fm_ADDR_BITWIDTH - 1 : 0]         FIFO_AR_req_ADDR           [0 : FIFO_DEPTH - 1]; 
reg    [fm_ADDR_BITWIDTH - 1 : 0]         FIFO_AR_req_ADDR_tmp; 
...
// WDATA fifo
reg    [fm_DATA_BITWIDTH - 1 : 0]         FIFO_WDATA           [0 : FIFO_DEPTH - 1]; 
reg    [fm_DATA_BITWIDTH/8 - 1 : 0]       FIFO_WSTRB           [0 : FIFO_DEPTH - 1]; 
...
reg    BRESP_tmp = 0;
reg    [fm_ID_BITWIDTH - 1 : 0] BID_tmp = 0;
reg    send_one_BRESP = 0;
reg    [31 : 0] BRESP_counter = 0;

reg [fm_DATA_BITWIDTH - 1:0] RDATA_tmp = 0;
reg [2 - 1:0] RRESP_tmp = 0;
reg RLAST_tmp = 0;
reg RVALID_tmp = 0;
reg [fm_ID_BITWIDTH - 1 : 0] RID_tmp = 0;
reg [fm_DATA_BITWIDTH - 1 : 0] fm_mem_0 [0: fm_mem_depth - 1] = '{default : 'h0}; 
reg [fm_DATA_BITWIDTH - 1 : 0] fm_mem_1 [0: fm_mem_depth - 1] = '{default : 'h0}; 
reg [fm_DATA_BITWIDTH - 1 : 0] fm_mem_2 [0: fm_mem_depth - 1] = '{default : 'h0}; 
reg [31 : 0] clk_counter ;
reg [31 : 0] current_AW_req_transaction = 0 ;
reg [31 : 0] current_AR_req_transaction = -1 ;
reg write_processing = 0;
reg [fm_ADDR_BITWIDTH - 1 : 0] wr_processing_addr = 0;
reg [fm_ADDR_BITWIDTH - 1 : 0] rd_processing_addr = 0;
reg [31 : 0] wr_processing_trans_num = 0;
reg [fm_DATA_BITWIDTH - 1 : 0] wr_processing_data = 0;
assign TRAN_fm_AWREADY    =    !FIFO_AW_req_full; 
assign TRAN_fm_ARREADY    =    !FIFO_AR_req_full; 
assign TRAN_fm_WREADY    =     !(FIFO_WDATA_req_full || FIFO_WDATA_size_full); 
assign TRAN_fm_BVALID = (BRESP_counter == 0) ? 0 : 1;
assign TRAN_fm_BRESP = BRESP_tmp;
assign TRAN_fm_BID = BID_tmp;
assign TRAN_fm_RDATA = RDATA_tmp;
assign TRAN_fm_RRESP = RRESP_tmp;
assign TRAN_fm_RLAST = RLAST_tmp;
assign TRAN_fm_RID = RID_tmp;
assign TRAN_fm_RVALID = RVALID_tmp;

initial begin : initialize_offset
  integer DATA_byte_num; 
  integer c_bitwidth;
  DATA_byte_num = 0; 
  c_bitwidth = fm_C_DATA_BITWIDTH;
end
...
always @ (posedge clk or reset) begin 
    if(reset === 0) begin 
        ...
        if(TRAN_fm_AWREADY & TRAN_fm_AWVALID ) begin    // RTL is sending a AW_request to the bus         
            FIFO_AW_req_SIZE [FIFO_AW_req_ptr_w]    =   TRAN_fm_AWSIZE; 
            FIFO_AW_req_ADDR [FIFO_AW_req_ptr_w]    =   TRAN_fm_AWADDR; 
            FIFO_AW_req_LEN  [FIFO_AW_req_ptr_w]    =   TRAN_fm_AWLEN; 
            FIFO_AW_req_BURST[FIFO_AW_req_ptr_w]    =   TRAN_fm_AWBURST; 
            FIFO_AW_req_ID[FIFO_AW_req_ptr_w]    =   TRAN_fm_AWID; 
...
always @ (posedge clk or reset) begin 
    if(reset === 0) begin 
        ...
        if(TRAN_fm_ARREADY & TRAN_fm_ARVALID ) begin    // RTL is sending a AR_request to the bus         
            FIFO_AR_req_SIZE [FIFO_AR_req_ptr_w]    =   TRAN_fm_ARSIZE; 
            FIFO_AR_req_ADDR [FIFO_AR_req_ptr_w]    =   TRAN_fm_ARADDR; 
            FIFO_AR_req_LEN  [FIFO_AR_req_ptr_w]    =   TRAN_fm_ARLEN; 
            FIFO_AR_req_BURST[FIFO_AR_req_ptr_w]    =   TRAN_fm_ARBURST; 
            FIFO_AR_req_ID[FIFO_AR_req_ptr_w]    =   TRAN_fm_ARID; 
...
always @ (posedge clk or reset) begin 
    if(reset === 0) begin 
        ...
        if(TRAN_fm_WREADY & TRAN_fm_WVALID) begin    // RTL is sending a WDATA data 
            FIFO_WDATA [FIFO_WDATA_req_ptr_w]    <=   TRAN_fm_WDATA; 
            FIFO_WSTRB [FIFO_WDATA_req_ptr_w]    <=   TRAN_fm_WSTRB; 
            if(FIFO_WDATA_req_ptr_w != FIFO_DEPTH - 1) 
                FIFO_WDATA_req_ptr_w <= FIFO_WDATA_req_ptr_w + 1; 
            else 
                FIFO_WDATA_req_ptr_w <= 0; 
            if (TRAN_fm_WLAST == 1 ) begin
...
always @(posedge clk or reset) begin 
    if(reset === 0) begin 
      ...
      if(TRAN_fm_AWVALID && TRAN_fm_AWREADY && ((FIFO_AW_req_ptr_w - FIFO_AW_req_ptr_r) % FIFO_DEPTH == FIFO_DEPTH - 1)) 
          FIFO_AW_req_flag <= 1; 
      # 0.4;
...
always @(posedge clk or reset) begin 
    if(reset === 0) begin 
      ...
      if(TRAN_fm_ARVALID && TRAN_fm_ARREADY && ((FIFO_AR_req_ptr_w - FIFO_AR_req_ptr_r) % FIFO_DEPTH == FIFO_DEPTH - 1)) 
          FIFO_AR_req_flag <= 1; 
      # 0.4;
...
always @(posedge clk or reset) begin 
    if(reset === 0) begin 
      ...
      if(TRAN_fm_WVALID && TRAN_fm_WREADY && ((FIFO_WDATA_req_ptr_w - FIFO_WDATA_req_ptr_r) % FIFO_DEPTH == FIFO_DEPTH - 1)) 
...
always @(posedge clk or reset) begin 
    if(reset === 0) begin 
      ...
      if(TRAN_fm_WVALID && TRAN_fm_WREADY && TRAN_fm_WLAST && ((FIFO_WDATA_size_ptr_w - FIFO_WDATA_size_ptr_r) % FIFO_DEPTH == FIFO_DEPTH - 1)) 
...
always @(posedge clk or reset) begin 
    if(reset === 0) begin 
        ...
        if ( send_one_BRESP == 'b1 && !(BRESP_counter != 32'h0 && TRAN_fm_BREADY) ) begin
            BRESP_counter <= BRESP_counter + 1;
        end else if (send_one_BRESP != 'b1 && (BRESP_counter != 32'h0 && TRAN_fm_BREADY)) begin
            BRESP_counter <= BRESP_counter - 1;
        end
    end
end
...
initial begin : AW_request_proc
    ...
    reg [fm_DATA_BITWIDTH - 1 : 0] FIFO_WDATA_tmp;
    reg [fm_DATA_BITWIDTH - 1 : 0] WDATA_tmp;
    reg [fm_DATA_BITWIDTH/8 - 1 : 0] FIFO_WSTRB_tmp;
    @(posedge clk);
    ...
    while (1) begin
        if (FIFO_AW_req_empty === 1 || BRESP_counter == 32) begin
            ...
            if (FIFO_AW_req_ADDR_tmp/data_byte_size > fm_mem_depth) begin
                $display ("F:/vivado_projects/EE4951_TaWork/ultra96ms2_418/solution1/sim/verilog/AESL_axi_master_fm.v: Write request address %d exceed AXI master fm array depth: %d",FIFO_AW_req_ADDR_tmp/data_byte_size, fm_mem_depth); 
                $finish;
            end
            ...
            if (FIFO_AW_req_BURST_tmp === 1) begin
                ...
                while (counter != output_length + 1) begin
                    if (FIFO_WDATA_req_empty != 1) begin 
                            ...
                            if (FIFO_WSTRB_tmp[i] == 1) begin 
                                ...
                                for (j=(i*8); j< (i+1)*8 ; j= j+1) begin
                                    case(FIFO_AW_req_transaction_tmp % mem_page_num)
                                        0 : WDATA_tmp[j] = fm_mem_0[FIFO_AW_req_ADDR_tmp / data_byte_size + counter][j];
                                        1 : WDATA_tmp[j] = fm_mem_1[FIFO_AW_req_ADDR_tmp / data_byte_size + counter][j];
                                        2 : WDATA_tmp[j] = fm_mem_2[FIFO_AW_req_ADDR_tmp / data_byte_size + counter][j];
                        ...
                        case(FIFO_AW_req_transaction_tmp % mem_page_num)
                            0 : fm_mem_0[FIFO_AW_req_ADDR_tmp / data_byte_size + counter] <= WDATA_tmp;
                            1 : fm_mem_1[FIFO_AW_req_ADDR_tmp / data_byte_size + counter] <= WDATA_tmp;
                            2 : fm_mem_2[FIFO_AW_req_ADDR_tmp / data_byte_size + counter] <= WDATA_tmp;
                            default: $display("The page_num of AXI write is not valid!");
                        endcase
                    ...
                    if (FIFO_WDATA_req_empty != 1) begin 
                        ...
                        for (i = 0 ; i < data_byte_size; i = i + 1) begin
                            if (FIFO_WSTRB_tmp[i] == 1) begin 
                                ...
                                for (j=(i*8); j< (i+1)*8 ; j= j+1) begin
                                    case(FIFO_AW_req_transaction_tmp % mem_page_num)
                                        0 : WDATA_tmp[j] = fm_mem_0[FIFO_AW_req_ADDR_tmp / data_byte_size][j];
                                        1 : WDATA_tmp[j] = fm_mem_1[FIFO_AW_req_ADDR_tmp / data_byte_size][j];
                                        2 : WDATA_tmp[j] = fm_mem_2[FIFO_AW_req_ADDR_tmp / data_byte_size][j];
                                        default: $display("The page_num of AXI write is not valid!");
                                    endcase
                                end
                            end
                        ...
                        wr_processing_data = WDATA_tmp;
                        case(FIFO_AW_req_transaction_tmp % mem_page_num)
                            0 : fm_mem_0[FIFO_AW_req_ADDR_tmp / data_byte_size] <= WDATA_tmp;
                            1 : fm_mem_1[FIFO_AW_req_ADDR_tmp / data_byte_size] <= WDATA_tmp;
                            2 : fm_mem_2[FIFO_AW_req_ADDR_tmp / data_byte_size] <= WDATA_tmp;
                            default: $display("The page_num of AXI write is not valid!");
                        endcase
...
initial begin : AR_request_proc
    ...
    while (1) begin
        ...
        if (FIFO_AR_req_empty) begin
            ...
            if (FIFO_AR_req_ADDR_tmp/data_byte_size > fm_mem_depth) begin
                $display ("F:/vivado_projects/EE4951_TaWork/ultra96ms2_418/solution1/sim/verilog/AESL_axi_master_fm.v: Read request address %d exceed AXI master fm array depth: %d",FIFO_AR_req_ADDR_tmp/data_byte_size, fm_mem_depth); 
                $finish;
            end
            ...
            if (FIFO_AR_req_BURST_tmp === 1) begin
                ...
                while (counter != input_length + 1) begin
                    ...
                    if ((write_processing == 1) && (wr_processing_addr == rd_processing_addr) && (wr_processing_trans_num == FIFO_AR_req_transaction_tmp))
                        ...
                        case(FIFO_AR_req_transaction_tmp % mem_page_num)
                            0 : RDATA_tmp <= fm_mem_0[FIFO_AR_req_ADDR_tmp / data_byte_size +   counter] ;
                            1 : RDATA_tmp <= fm_mem_1[FIFO_AR_req_ADDR_tmp / data_byte_size +   counter] ;
                            2 : RDATA_tmp <= fm_mem_2[FIFO_AR_req_ADDR_tmp / data_byte_size +   counter] ;
                    ...
                    @(posedge clk);
                    if (RVALID_tmp && TRAN_fm_RREADY) begin
                        counter = counter + 1;
                    end 
                end
                RVALID_tmp <= 0;
                ...
                while (counter != input_length + 1) begin
                    ...
                    if ((write_processing == 1) && (wr_processing_addr == rd_processing_addr) && (wr_processing_trans_num == FIFO_AR_req_transaction_tmp))
                        ...
                        case(FIFO_AR_req_transaction_tmp % mem_page_num)
                            0 : RDATA_tmp <= fm_mem_0[FIFO_AR_req_ADDR_tmp / data_byte_size ] ;
                            1 : RDATA_tmp <= fm_mem_1[FIFO_AR_req_ADDR_tmp / data_byte_size ] ;
                            2 : RDATA_tmp <= fm_mem_2[FIFO_AR_req_ADDR_tmp / data_byte_size ] ;
                            default: $display("The page_num of AXI read is not valid!");
                        endcase
                    RVALID_tmp <= 1;
                    RRESP_tmp <= 0;
...
initial begin : read_file_process 
  ...
  reg [fm_DATA_BITWIDTH - 1 : 0] mem_tmp; 
  integer i; 
  transaction_num = 0;
  fp = $fopen(`TV_IN_fm,"rb"); 
  if(fp == 0) begin                               // Failed to open file 
      $display("Failed to open file \"%s\"!", `TV_IN_fm); 
      $finish; 
  end 
  ...
  while (trans_depth != 64'h5a5aa5a50f0ff0f0)  begin
      ...
      mem_tmp[fm_DATA_BITWIDTH - 1: 0] = 0;
      for(i = 0; i < fm_transaction_depth; i = i + 1) begin 
          ...
          if (i%2 == 1) begin
              case(mem_page)
                  0 : fm_mem_0[i/2] = mem_tmp;
                  1 : fm_mem_1[i/2] = mem_tmp;
                  2 : fm_mem_2[i/2] = mem_tmp;
...
initial begin : write_file_proc 
  ...
  integer j; 
  integer mem_page; 
  reg [fm_C_DATA_BITWIDTH - 1 : 0] mem_tmp; 
  reg [fm_DATA_BITWIDTH - 1 : 0] tmp_data;
  reg [63:0] bin_data;
  transaction_num = 0; 
  while(1) begin 
      @(posedge clk);
      ...
      mem_page = transaction_num % mem_page_num ;
      # 0.1;
      fp = $fopen(`TV_OUT_fm, "ab"); 
      if(fp == 0) begin       // Failed to open file 
          $display("Failed to open file \"%s\"!", `TV_OUT_fm); 
          $finish; 
      end 
      bin_data = fm_transaction_depth;
      write_binary(fp,bin_data,64);
      for(i = 0; i < fm_mem_depth; i = i + 1) begin 
          case(mem_page)
              0 : tmp_data = fm_mem_0[i];
              1 : tmp_data = fm_mem_1[i];
              2 : tmp_data = fm_mem_2[i];
