...
if {[file isfile main_func.autotvin.dat]} {
	file delete -force main_func.autotvin.dat
}

if {[file isfile main_func.autotvout.dat]} {
	file delete -force main_func.autotvout.dat
}
