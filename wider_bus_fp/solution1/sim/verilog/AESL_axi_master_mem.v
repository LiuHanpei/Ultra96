...
//------------------------Parameter----------------------
`define TV_IN_mem "../tv/cdatafile/c.main_func.autotvin_mem.dat"
`define TV_OUT_mem "../tv/rtldatafile/rtl.main_func.autotvout_mem.dat"
 parameter mem_ADDR_BITWIDTH = 32'd 64;
 parameter mem_AWUSER_BITWIDTH = 32'd 1;
 parameter mem_DATA_BITWIDTH = 32'd 256;
 parameter mem_WUSER_BITWIDTH = 32'd 1;
 parameter mem_ID_BITWIDTH = 32'd 1;
 parameter mem_RUSER_BITWIDTH = 32'd 1;
 parameter mem_BUSER_BITWIDTH = 32'd 1;
 parameter   FIFO_DEPTH            =   1 + 1;
 parameter   mem_page_num            =   32'd 3;
 parameter   FIFO_DEPTH_ADDR_WIDTH   =    32'd 32;
parameter mem_C_DATA_BITWIDTH = 32'd 256;
parameter mem_transaction_depth = 32'd 10;
parameter mem_mem_depth = 32'd 10;
parameter ReadReqLatency = 32'd 1;
parameter WriteReqLatency = 32'd 1;
// Input and Output
input clk;
input reset;
input  TRAN_mem_AWVALID;
output  TRAN_mem_AWREADY;
input [mem_ADDR_BITWIDTH - 1 : 0] TRAN_mem_AWADDR;
input [mem_ID_BITWIDTH - 1 : 0] TRAN_mem_AWID;
input [8 - 1 : 0] TRAN_mem_AWLEN;
input [3 - 1 : 0] TRAN_mem_AWSIZE;
input [2 - 1 : 0] TRAN_mem_AWBURST;
input [2 - 1 : 0] TRAN_mem_AWLOCK;
input [4 - 1 : 0] TRAN_mem_AWCACHE;
input [3 - 1 : 0] TRAN_mem_AWPROT;
input [4 - 1 : 0] TRAN_mem_AWQOS;
input [4 - 1 : 0] TRAN_mem_AWREGION;
input [mem_AWUSER_BITWIDTH - 1 : 0] TRAN_mem_AWUSER;
input  TRAN_mem_WVALID;
output  TRAN_mem_WREADY;
input [mem_DATA_BITWIDTH - 1 : 0] TRAN_mem_WDATA;
input [mem_DATA_BITWIDTH/8 - 1 : 0] TRAN_mem_WSTRB;
input  TRAN_mem_WLAST;
input  TRAN_mem_WID;
input [mem_WUSER_BITWIDTH - 1 : 0] TRAN_mem_WUSER;
input  TRAN_mem_ARVALID;
output  TRAN_mem_ARREADY;
input [mem_ADDR_BITWIDTH - 1 : 0] TRAN_mem_ARADDR;
input [mem_ID_BITWIDTH - 1 : 0] TRAN_mem_ARID;
input [8 - 1 : 0] TRAN_mem_ARLEN;
input [3 - 1 : 0] TRAN_mem_ARSIZE;
input [2 - 1 : 0] TRAN_mem_ARBURST;
input [2 - 1 : 0] TRAN_mem_ARLOCK;
input [4 - 1 : 0] TRAN_mem_ARCACHE;
input [3 - 1 : 0] TRAN_mem_ARPROT;
input [4 - 1 : 0] TRAN_mem_ARQOS;
input [4 - 1 : 0] TRAN_mem_ARREGION;
input  TRAN_mem_ARUSER;
output  TRAN_mem_RVALID;
input  TRAN_mem_RREADY;
output [mem_DATA_BITWIDTH - 1 : 0] TRAN_mem_RDATA;
output  TRAN_mem_RLAST;
output [mem_ID_BITWIDTH - 1 : 0] TRAN_mem_RID;
output [mem_RUSER_BITWIDTH - 1 : 0] TRAN_mem_RUSER;
output [2 - 1 : 0] TRAN_mem_RRESP;
output  TRAN_mem_BVALID;
input  TRAN_mem_BREADY;
output [2 - 1 : 0] TRAN_mem_BRESP;
output [mem_ID_BITWIDTH - 1 : 0] TRAN_mem_BID;
output [mem_BUSER_BITWIDTH - 1 : 0] TRAN_mem_BUSER;
input ready;
input done;

// Inner signals
// AW request fifo
reg    [mem_ADDR_BITWIDTH - 1 : 0]         FIFO_AW_req_ADDR           [0 : FIFO_DEPTH - 1]; 
reg    [mem_ADDR_BITWIDTH - 1 : 0]         FIFO_AW_req_ADDR_tmp; 
...
// AR request fifo
reg    [mem_ADDR_BITWIDTH - 1 : 0]         FIFO_AR_req_ADDR           [0 : FIFO_DEPTH - 1]; 
reg    [mem_ADDR_BITWIDTH - 1 : 0]         FIFO_AR_req_ADDR_tmp; 
...
// WDATA fifo
reg    [mem_DATA_BITWIDTH - 1 : 0]         FIFO_WDATA           [0 : FIFO_DEPTH - 1]; 
reg    [mem_DATA_BITWIDTH/8 - 1 : 0]       FIFO_WSTRB           [0 : FIFO_DEPTH - 1]; 
...
reg    BRESP_tmp = 0;
reg    [mem_ID_BITWIDTH - 1 : 0] BID_tmp = 0;
reg    send_one_BRESP = 0;
reg    [31 : 0] BRESP_counter = 0;

reg [mem_DATA_BITWIDTH - 1:0] RDATA_tmp = 0;
reg [2 - 1:0] RRESP_tmp = 0;
reg RLAST_tmp = 0;
reg RVALID_tmp = 0;
reg [mem_ID_BITWIDTH - 1 : 0] RID_tmp = 0;
reg [mem_DATA_BITWIDTH - 1 : 0] mem_mem_0 [0: mem_mem_depth - 1] = '{default : 'h0}; 
reg [mem_DATA_BITWIDTH - 1 : 0] mem_mem_1 [0: mem_mem_depth - 1] = '{default : 'h0}; 
reg [mem_DATA_BITWIDTH - 1 : 0] mem_mem_2 [0: mem_mem_depth - 1] = '{default : 'h0}; 
reg [31 : 0] clk_counter ;
reg [31 : 0] current_AW_req_transaction = 0 ;
reg [31 : 0] current_AR_req_transaction = -1 ;
reg write_processing = 0;
reg [mem_ADDR_BITWIDTH - 1 : 0] wr_processing_addr = 0;
reg [mem_ADDR_BITWIDTH - 1 : 0] rd_processing_addr = 0;
reg [31 : 0] wr_processing_trans_num = 0;
reg [mem_DATA_BITWIDTH - 1 : 0] wr_processing_data = 0;
assign TRAN_mem_AWREADY    =    !FIFO_AW_req_full; 
assign TRAN_mem_ARREADY    =    !FIFO_AR_req_full; 
assign TRAN_mem_WREADY    =     !(FIFO_WDATA_req_full || FIFO_WDATA_size_full); 
assign TRAN_mem_BVALID = (BRESP_counter == 0) ? 0 : 1;
assign TRAN_mem_BRESP = BRESP_tmp;
assign TRAN_mem_BID = BID_tmp;
assign TRAN_mem_RDATA = RDATA_tmp;
assign TRAN_mem_RRESP = RRESP_tmp;
assign TRAN_mem_RLAST = RLAST_tmp;
assign TRAN_mem_RID = RID_tmp;
assign TRAN_mem_RVALID = RVALID_tmp;

initial begin : initialize_offset
  integer DATA_byte_num; 
  integer c_bitwidth;
  DATA_byte_num = 0; 
  c_bitwidth = mem_C_DATA_BITWIDTH;
end
...
always @ (posedge clk or reset) begin 
    if(reset === 0) begin 
        ...
        if(TRAN_mem_AWREADY & TRAN_mem_AWVALID ) begin    // RTL is sending a AW_request to the bus         
            FIFO_AW_req_SIZE [FIFO_AW_req_ptr_w]    =   TRAN_mem_AWSIZE; 
            FIFO_AW_req_ADDR [FIFO_AW_req_ptr_w]    =   TRAN_mem_AWADDR; 
            FIFO_AW_req_LEN  [FIFO_AW_req_ptr_w]    =   TRAN_mem_AWLEN; 
            FIFO_AW_req_BURST[FIFO_AW_req_ptr_w]    =   TRAN_mem_AWBURST; 
            FIFO_AW_req_ID[FIFO_AW_req_ptr_w]    =   TRAN_mem_AWID; 
...
always @ (posedge clk or reset) begin 
    if(reset === 0) begin 
        ...
        if(TRAN_mem_ARREADY & TRAN_mem_ARVALID ) begin    // RTL is sending a AR_request to the bus         
            FIFO_AR_req_SIZE [FIFO_AR_req_ptr_w]    =   TRAN_mem_ARSIZE; 
            FIFO_AR_req_ADDR [FIFO_AR_req_ptr_w]    =   TRAN_mem_ARADDR; 
            FIFO_AR_req_LEN  [FIFO_AR_req_ptr_w]    =   TRAN_mem_ARLEN; 
            FIFO_AR_req_BURST[FIFO_AR_req_ptr_w]    =   TRAN_mem_ARBURST; 
            FIFO_AR_req_ID[FIFO_AR_req_ptr_w]    =   TRAN_mem_ARID; 
...
always @ (posedge clk or reset) begin 
    if(reset === 0) begin 
        ...
        if(TRAN_mem_WREADY & TRAN_mem_WVALID) begin    // RTL is sending a WDATA data 
            FIFO_WDATA [FIFO_WDATA_req_ptr_w]    <=   TRAN_mem_WDATA; 
            FIFO_WSTRB [FIFO_WDATA_req_ptr_w]    <=   TRAN_mem_WSTRB; 
            if(FIFO_WDATA_req_ptr_w != FIFO_DEPTH - 1) 
                FIFO_WDATA_req_ptr_w <= FIFO_WDATA_req_ptr_w + 1; 
            else 
                FIFO_WDATA_req_ptr_w <= 0; 
            if (TRAN_mem_WLAST == 1 ) begin
...
always @(posedge clk or reset) begin 
    if(reset === 0) begin 
      ...
      if(TRAN_mem_AWVALID && TRAN_mem_AWREADY && ((FIFO_AW_req_ptr_w - FIFO_AW_req_ptr_r) % FIFO_DEPTH == FIFO_DEPTH - 1)) 
          FIFO_AW_req_flag <= 1; 
      # 0.4;
...
always @(posedge clk or reset) begin 
    if(reset === 0) begin 
      ...
      if(TRAN_mem_ARVALID && TRAN_mem_ARREADY && ((FIFO_AR_req_ptr_w - FIFO_AR_req_ptr_r) % FIFO_DEPTH == FIFO_DEPTH - 1)) 
          FIFO_AR_req_flag <= 1; 
      # 0.4;
...
always @(posedge clk or reset) begin 
    if(reset === 0) begin 
      ...
      if(TRAN_mem_WVALID && TRAN_mem_WREADY && ((FIFO_WDATA_req_ptr_w - FIFO_WDATA_req_ptr_r) % FIFO_DEPTH == FIFO_DEPTH - 1)) 
...
always @(posedge clk or reset) begin 
    if(reset === 0) begin 
      ...
      if(TRAN_mem_WVALID && TRAN_mem_WREADY && TRAN_mem_WLAST && ((FIFO_WDATA_size_ptr_w - FIFO_WDATA_size_ptr_r) % FIFO_DEPTH == FIFO_DEPTH - 1)) 
...
always @(posedge clk or reset) begin 
    if(reset === 0) begin 
        ...
        if ( send_one_BRESP == 'b1 && !(BRESP_counter != 32'h0 && TRAN_mem_BREADY) ) begin
            BRESP_counter <= BRESP_counter + 1;
        end else if (send_one_BRESP != 'b1 && (BRESP_counter != 32'h0 && TRAN_mem_BREADY)) begin
            BRESP_counter <= BRESP_counter - 1;
        end
    end
end
...
initial begin : AW_request_proc
    ...
    reg [mem_DATA_BITWIDTH - 1 : 0] FIFO_WDATA_tmp;
    reg [mem_DATA_BITWIDTH - 1 : 0] WDATA_tmp;
    reg [mem_DATA_BITWIDTH/8 - 1 : 0] FIFO_WSTRB_tmp;
    @(posedge clk);
    ...
    while (1) begin
        if (FIFO_AW_req_empty === 1 || BRESP_counter == 32) begin
            ...
            if (FIFO_AW_req_ADDR_tmp/data_byte_size > mem_mem_depth) begin
                $display ("F:/vivado_projects/EE4951_TaWork/wider_bus_fp/solution1/sim/verilog/AESL_axi_master_mem.v: Write request address %d exceed AXI master mem array depth: %d",FIFO_AW_req_ADDR_tmp/data_byte_size, mem_mem_depth); 
                $finish;
            end
            ...
            if (FIFO_AW_req_BURST_tmp === 1) begin
                ...
                while (counter != output_length + 1) begin
                    if (FIFO_WDATA_req_empty != 1) begin 
                            ...
                            if (FIFO_WSTRB_tmp[i] == 1) begin 
                                ...
                                for (j=(i*8); j< (i+1)*8 ; j= j+1) begin
                                    case(FIFO_AW_req_transaction_tmp % mem_page_num)
                                        0 : WDATA_tmp[j] = mem_mem_0[FIFO_AW_req_ADDR_tmp / data_byte_size + counter][j];
                                        1 : WDATA_tmp[j] = mem_mem_1[FIFO_AW_req_ADDR_tmp / data_byte_size + counter][j];
                                        2 : WDATA_tmp[j] = mem_mem_2[FIFO_AW_req_ADDR_tmp / data_byte_size + counter][j];
                        ...
                        case(FIFO_AW_req_transaction_tmp % mem_page_num)
                            0 : mem_mem_0[FIFO_AW_req_ADDR_tmp / data_byte_size + counter] <= WDATA_tmp;
                            1 : mem_mem_1[FIFO_AW_req_ADDR_tmp / data_byte_size + counter] <= WDATA_tmp;
                            2 : mem_mem_2[FIFO_AW_req_ADDR_tmp / data_byte_size + counter] <= WDATA_tmp;
                            default: $display("The page_num of AXI write is not valid!");
                        endcase
                    ...
                    if (FIFO_WDATA_req_empty != 1) begin 
                        ...
                        for (i = 0 ; i < data_byte_size; i = i + 1) begin
                            if (FIFO_WSTRB_tmp[i] == 1) begin 
                                ...
                                for (j=(i*8); j< (i+1)*8 ; j= j+1) begin
                                    case(FIFO_AW_req_transaction_tmp % mem_page_num)
                                        0 : WDATA_tmp[j] = mem_mem_0[FIFO_AW_req_ADDR_tmp / data_byte_size][j];
                                        1 : WDATA_tmp[j] = mem_mem_1[FIFO_AW_req_ADDR_tmp / data_byte_size][j];
                                        2 : WDATA_tmp[j] = mem_mem_2[FIFO_AW_req_ADDR_tmp / data_byte_size][j];
                                        default: $display("The page_num of AXI write is not valid!");
                                    endcase
                                end
                            end
                        ...
                        wr_processing_data = WDATA_tmp;
                        case(FIFO_AW_req_transaction_tmp % mem_page_num)
                            0 : mem_mem_0[FIFO_AW_req_ADDR_tmp / data_byte_size] <= WDATA_tmp;
                            1 : mem_mem_1[FIFO_AW_req_ADDR_tmp / data_byte_size] <= WDATA_tmp;
                            2 : mem_mem_2[FIFO_AW_req_ADDR_tmp / data_byte_size] <= WDATA_tmp;
                            default: $display("The page_num of AXI write is not valid!");
                        endcase
...
initial begin : AR_request_proc
    ...
    while (1) begin
        ...
        if (FIFO_AR_req_empty) begin
            ...
            if (FIFO_AR_req_ADDR_tmp/data_byte_size > mem_mem_depth) begin
                $display ("F:/vivado_projects/EE4951_TaWork/wider_bus_fp/solution1/sim/verilog/AESL_axi_master_mem.v: Read request address %d exceed AXI master mem array depth: %d",FIFO_AR_req_ADDR_tmp/data_byte_size, mem_mem_depth); 
                $finish;
            end
            ...
            if (FIFO_AR_req_BURST_tmp === 1) begin
                ...
                while (counter != input_length + 1) begin
                    ...
                    if ((write_processing == 1) && (wr_processing_addr == rd_processing_addr) && (wr_processing_trans_num == FIFO_AR_req_transaction_tmp))
                        ...
                        case(FIFO_AR_req_transaction_tmp % mem_page_num)
                            0 : RDATA_tmp <= mem_mem_0[FIFO_AR_req_ADDR_tmp / data_byte_size +   counter] ;
                            1 : RDATA_tmp <= mem_mem_1[FIFO_AR_req_ADDR_tmp / data_byte_size +   counter] ;
                            2 : RDATA_tmp <= mem_mem_2[FIFO_AR_req_ADDR_tmp / data_byte_size +   counter] ;
                    ...
                    @(posedge clk);
                    if (RVALID_tmp && TRAN_mem_RREADY) begin
                        counter = counter + 1;
                    end 
                end
                RVALID_tmp <= 0;
                ...
                while (counter != input_length + 1) begin
                    ...
                    if ((write_processing == 1) && (wr_processing_addr == rd_processing_addr) && (wr_processing_trans_num == FIFO_AR_req_transaction_tmp))
                        ...
                        case(FIFO_AR_req_transaction_tmp % mem_page_num)
                            0 : RDATA_tmp <= mem_mem_0[FIFO_AR_req_ADDR_tmp / data_byte_size ] ;
                            1 : RDATA_tmp <= mem_mem_1[FIFO_AR_req_ADDR_tmp / data_byte_size ] ;
                            2 : RDATA_tmp <= mem_mem_2[FIFO_AR_req_ADDR_tmp / data_byte_size ] ;
                            default: $display("The page_num of AXI read is not valid!");
                        endcase
                    RVALID_tmp <= 1;
                    RRESP_tmp <= 0;
...
initial begin : read_file_process 
  ...
  reg [mem_DATA_BITWIDTH - 1 : 0] mem_tmp; 
  integer i; 
  transaction_num = 0;
  fp = $fopen(`TV_IN_mem,"rb"); 
  if(fp == 0) begin                               // Failed to open file 
      $display("Failed to open file \"%s\"!", `TV_IN_mem); 
      $finish; 
  end 
  ...
  while (trans_depth != 64'h5a5aa5a50f0ff0f0)  begin
      ...
      mem_tmp[mem_DATA_BITWIDTH - 1: 0] = 0;
      for(i = 0; i < mem_transaction_depth; i = i + 1) begin 
          ...
          if (i%1 == 0) begin
              case(mem_page)
                  0 : mem_mem_0[i/1] = mem_tmp;
                  1 : mem_mem_1[i/1] = mem_tmp;
                  2 : mem_mem_2[i/1] = mem_tmp;
...
initial begin : write_file_proc 
  ...
  integer j; 
  integer mem_page; 
  reg [mem_C_DATA_BITWIDTH - 1 : 0] mem_tmp; 
  reg [mem_DATA_BITWIDTH - 1 : 0] tmp_data;
  ...
  while(1) begin 
      ...
      mem_page = transaction_num % mem_page_num ;
      # 0.1;
      fp = $fopen(`TV_OUT_mem, "ab"); 
      if(fp == 0) begin       // Failed to open file 
          $display("Failed to open file \"%s\"!", `TV_OUT_mem); 
          $finish; 
      end 
      bin_data = mem_transaction_depth;
      write_binary(fp,bin_data,64);
      for(i = 0; i < mem_mem_depth; i = i + 1) begin 
          case(mem_page)
              0 : tmp_data = mem_mem_0[i];
              1 : tmp_data = mem_mem_1[i];
              2 : tmp_data = mem_mem_2[i];
